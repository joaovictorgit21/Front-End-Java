...
public class NavegadorDeRegistro {
    ...
    public static String[] UpdateRegister(String db, String tbl, String name, String email, String id) throws Exception {

        String retorno = "Oi!!!!";
            try {
                Connection connection = MySQLConnector.connection();
                String strSqlUpdateRegister = "update `" + db + "`.`" + tbl + "` set `name` = '" + name + "', `email` = '" + email + "';";
    ...
    public static String[] searchRegister(String db, String tbl, String campo1, String campo2, String name, String email) throws Exception {
        ...
        try {
            Connection conexao = MySQLConnector.connection();
            String strSqlsearchRegister = "select id, name, email, password FROM `" + db + "`.`" + tbl + "` where `" + campo1 + "` = '" + name + "' OR `" + campo2 + "` = '" + email + "' order by `id` asc;";
